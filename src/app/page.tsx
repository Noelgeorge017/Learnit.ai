      ...
      <div>
            ...
            <div className="bg-gray-1100 text-white">
              <section className="container mx-auto px-4 py-16 flex flex-col items-center">
                <h1 className="text-2xl py-6 mb-4 font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-transparent bg-gradient-to-r from-purple-400 via-cyan-500 to-blue-500 bg-clip-text bg-repeat-no-repeat bg-size-500% animate-text-shine">Flexible & Limitless Learning <br /> Craft your learning journey ...</h1>
        ...
        <div className="text-center ">
          ...
          <p className="text-lg">Engage in learning using our <br /> curated course structure.</p>
        </div>
        <div className="text-center">
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 via-purple-500 mb-4">
            Customized Experience
          </h2>
          <p className="text-lg">Learning crafted to your <br /> preferences and study goals .</p>
        </div>
        <div className="text-center">
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 via-purple-500 mb-4">
            Flexible interface
          </h2>
          <p className="text-lg">All-round learning with <br /> lectures, summary, quizzes etc.</p>
        </div>
      </div>
